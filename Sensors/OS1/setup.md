...
Isaac Sim already has the OS1. Add the OS1 sensor to the scene: Create > Sensors > RTX Lidar > Ouster > OS1. Make sure to move the sensor under the robot's body prim so that the sensor becomes attached to it. For example, on the spot robot, I have the "OS1" prim under the "body" prim.
